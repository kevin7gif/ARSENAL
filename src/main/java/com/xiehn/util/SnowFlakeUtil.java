...
public class SnowFlakeUtil {
    ...
    private static final    Logger      LOGGER             = Logger.getLogger(SnowFlakeUtil.class.getCanonicalName());
    ...
    private static final SnowFlakeUtil ID_WORKER = new SnowFlakeUtil(LOCAL_WORK_ID, LOCAL_NODE_ID);
